...
export default function Line({ line, layer, scene, catalog, drawingSupport }) {
  ...
  return (
    <Fragment>
      ...
      >
        ...
        {renderedHoles}
        {
          drawingSupport.get('lineID') === line.id &&
          <foreignObject x={x1} y={y1} width="60px" height="60px">
            <LineInput defaultValue={length} onChange={() => {}}></LineInput>
          </foreignObject>
        }
      </g>
    </Fragment>
