...
export default function Layer({ layer, scene, catalog, drawingSupport }) {
    ...
    <g opacity={opacity}>
      ...
      }
      {
        lines.valueSeq().map(line =>
          <Line key={line.id} layer={layer} line={line} scene={scene} catalog={catalog} drawingSupport={drawingSupport} />)
      }
      {
