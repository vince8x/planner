...
export default function ActiveDrawingHelper({snap, width, height}) {
  switch (snap.type) {
    ...
    case 'ortho':
      let h0 = Geometry.horizontalLine(0);
      let h1 = Geometry.horizontalLine(height);
      let hx = Geometry.horizontalLine(snap.y);
      let v0 = Geometry.verticalLine(0);
      let v1 = Geometry.verticalLine(width);
      let vx = Geometry.verticalLine(snap.x);

      let pointV0 = Geometry.twoLinesIntersection(vx.a, vx.b, vx.c, h0.a, h0.b, h0.c);
      let pointH0 = Geometry.twoLinesIntersection(hx.a, hx.b, hx.c, v0.a, v0.b, v0.c);

      let pointH1 = Geometry.twoLinesIntersection(v1.a, v1.b, v1.c, hx.a, hx.b, hx.c);
      let pointV1 = Geometry.twoLinesIntersection(h1.a, h1.b, h1.c, vx.a, vx.b, vx.c);


      if (pointH0 && pointH1 && pointV0 && pointV1) {
        return (
          <g>
            <line x1={pointH0.x} y1={pointH0.y} x2={pointH1.x} y2={pointH1.y} style={STYLE}/>
            <line x1={pointV0.x} y1={pointV0.y} x2={pointV1.x} y2={pointV1.y} style={STYLE}/>
          </g>);
      } else if (pointH0 && pointH1) {
        return <line x1={pointH0.x} y1={pointH0.y} x2={pointH1.x} y2={pointH1.y} style={STYLE}/>;
      } else if (pointV0 && pointV1) {
        return <line x1={pointV0.x} y1={pointV0.y} x2={pointV1.x} y2={pointV1.y} style={STYLE}/>;
      }
      return null;
    default:
