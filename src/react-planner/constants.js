...
export const SELECTED_OPTIMIZE_PLAN = 'SELECTED_OPTIMIZE_PLAN';
...
export const CATEGORY_MURO_DIVISORIO = {
  ID: 4,
  NAME: 'MURO DIVISORIO'
};

export const CATEGORY_MURO_INTERIOR = {
  ID: 5,
  NAME: 'MURO INTERIOR'
};

export const CATEGORY_MURO_PERIMETRAL = {
  ID: 6,
...
export const SOLUTION_CATEGORIES = [
  ...
  CATEGORY_MURO_INTERIOR,
  CATEGORY_MURO_PERIMETRAL
];
